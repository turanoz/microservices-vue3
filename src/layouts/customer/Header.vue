<template>
  ...
  <header class="header_wrap">
    <div class="middle-header dark_skin">
      <div class="container">
        <div class="nav_block">
          <router-link :to="{name:'shop'}" class="navbar-brand">
            <img class="logo_light" src="/src/assets/images/logo_light.png" alt="logo">
            <img class="logo_dark" src="/src/assets/images/logo_dark.png" alt="logo">
          </router-link>
